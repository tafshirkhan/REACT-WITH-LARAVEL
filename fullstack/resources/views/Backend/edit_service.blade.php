                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form method="post" action="{{ route('service.updatedata') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="service_name" class="form-control input-default "
                                            placeholder="input-default" value="{{ $data->service_name }}">
                                        @error('service_name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="service_description" rows="4"
                                            id="comment">value="{{ $data->service_description }}"</textarea>
                                    ...
                                    <div class="form-group">
                                        <img id="showImage" src="{{ asset($data->service_logo) }}"
