                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form method="post" action="{{ route('course.storedata') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="course_description" rows="4"
                                            id="comment"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="all_skill" rows="4" id="comment"></textarea>
                                        @error('all_skill')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <input type="submit" class="btn light btn-success" value="Add Course">
