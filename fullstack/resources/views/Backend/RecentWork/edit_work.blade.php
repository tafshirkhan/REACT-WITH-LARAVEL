                                ...
                                <form method="post" action="{{ route('project.update') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="project_name" class="form-control input-default "
                                            placeholder="input-default" value="{{ $data->project_name }}">
                                        @error('project_name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="project_feature" rows="4" id="comment">
                                                            {{ $data->project_feature }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="project_live_preview" class="form-control input-default "
                                            placeholder="input-default" value="{{ $data->project_live_preview }}">
                                    ...
                                    <div class="form-group">
                                        <img id="showImage_one" src="{{ asset($data->first_image) }}"
                                    ...
                                    <div class="form-group">
                                        <img id="showImage_two" src="{{ asset($data->second_image) }}"
                                            style="width: 100px; height:100px;">
                                    </div>



                                    <input type="submit" class="btn light btn-success" value="Update Project">
