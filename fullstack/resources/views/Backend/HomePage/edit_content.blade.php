                                ...
                                <form method="post" action="{{ route('homecontent.update') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="home_title" class="form-control input-default "
                                            placeholder="input-default" value="{{ $data->home_title }}">
                                        @error('home_title')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="home_subtitle" class="form-control input-default "
                                            placeholder="input-default" value="{{ $data->home_subtitle }}">
                                        @error('home_subtitle')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="analysis_description" rows="4" id="column">
                                                        {{ $data->analysis_description }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="total_course" class="form-control input-default "
                                            placeholder="input-default" value="{{ $data->total_course }}">
                                        @error('total_course')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="total_review" class="form-control input-default "
                                            placeholder="input-default" value="{{ $data->total_review }}">
                                        @error('total_review')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="video_dexcription" rows="4"
                                            id="column">{{ $data->video_dexcription }}</textarea>
