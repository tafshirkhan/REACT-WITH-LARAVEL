                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form method="post" action="{{ route('client_review.update') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="client_title" class="form-control input-default "
                                            placeholder="input-default" value="{{ $data->client_title }}">
                                        @error('client_title')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="client_description" rows="4"
                                            id="comment">{{ $data->client_description }}</textarea>
                                    ...
                                    <div class="form-group">
                                        <img id="showImage1" src="{{ asset($data->client_image) }}"
